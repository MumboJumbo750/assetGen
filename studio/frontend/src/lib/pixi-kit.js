export const zelosPaths = {
  ...
  astroDuck: {
    ...
    base: {
      front: "sprites/astro-duck/base/astro-duck-base-front.png",
      side: "sprites/astro-duck/base/astro-duck-base-side.png",
      threeQuarter: "sprites/astro-duck/base/astro-duck-base-three-quarter.png",
    },
    outfits: {
      "outfit-default-suit": {
        front: "sprites/astro-duck/outfits/outfit-default-suit-front.png",
        side: "sprites/astro-duck/outfits/outfit-default-suit-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-default-suit-three-quarter.png",
      },
      "outfit-pirate": {
        front: "sprites/astro-duck/outfits/outfit-pirate-front.png",
        side: "sprites/astro-duck/outfits/outfit-pirate-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-pirate-three-quarter.png",
      },
      "outfit-wizard": {
        front: "sprites/astro-duck/outfits/outfit-wizard-front.png",
        side: "sprites/astro-duck/outfits/outfit-wizard-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-wizard-three-quarter.png",
      },
      "outfit-detective": {
        front: "sprites/astro-duck/outfits/outfit-detective-front.png",
        side: "sprites/astro-duck/outfits/outfit-detective-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-detective-three-quarter.png",
      },
      "outfit-chef": {
        front: "sprites/astro-duck/outfits/outfit-chef-front.png",
        side: "sprites/astro-duck/outfits/outfit-chef-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-chef-three-quarter.png",
      },
      "outfit-superhero": {
        front: "sprites/astro-duck/outfits/outfit-superhero-front.png",
        side: "sprites/astro-duck/outfits/outfit-superhero-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-superhero-three-quarter.png",
      },
      "outfit-scientist": {
        front: "sprites/astro-duck/outfits/outfit-scientist-front.png",
        side: "sprites/astro-duck/outfits/outfit-scientist-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-scientist-three-quarter.png",
      },
      "outfit-musician": {
        front: "sprites/astro-duck/outfits/outfit-musician-front.png",
        side: "sprites/astro-duck/outfits/outfit-musician-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-musician-three-quarter.png",
      },
      "outfit-explorer": {
        front: "sprites/astro-duck/outfits/outfit-explorer-front.png",
        side: "sprites/astro-duck/outfits/outfit-explorer-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-explorer-three-quarter.png",
      },
      "outfit-ninja": {
        front: "sprites/astro-duck/outfits/outfit-ninja-front.png",
        side: "sprites/astro-duck/outfits/outfit-ninja-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-ninja-three-quarter.png",
      },
      "outfit-royal": {
        front: "sprites/astro-duck/outfits/outfit-royal-front.png",
        side: "sprites/astro-duck/outfits/outfit-royal-side.png",
        threeQuarter: "sprites/astro-duck/outfits/outfit-royal-three-quarter.png",
      },
    },
    expressions: {
      happy: {
        front: "sprites/astro-duck/expressions/astro-duck-happy-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-happy-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-happy-three-quarter.png",
      },
      excited: {
        front: "sprites/astro-duck/expressions/astro-duck-excited-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-excited-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-excited-three-quarter.png",
      },
      curious: {
        front: "sprites/astro-duck/expressions/astro-duck-curious-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-curious-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-curious-three-quarter.png",
      },
      concerned: {
        front: "sprites/astro-duck/expressions/astro-duck-concerned-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-concerned-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-concerned-three-quarter.png",
      },
      celebrating: {
        front: "sprites/astro-duck/expressions/astro-duck-celebrating-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-celebrating-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-celebrating-three-quarter.png",
      },
      sleeping: {
        front: "sprites/astro-duck/expressions/astro-duck-sleeping-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-sleeping-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-sleeping-three-quarter.png",
      },
      waving: {
        front: "sprites/astro-duck/expressions/astro-duck-waving-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-waving-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-waving-three-quarter.png",
      },
      pointing: {
        front: "sprites/astro-duck/expressions/astro-duck-pointing-front.png",
        side: "sprites/astro-duck/expressions/astro-duck-pointing-side.png",
        threeQuarter: "sprites/astro-duck/expressions/astro-duck-pointing-three-quarter.png",
      },
    },
...
export const zelosPresets = {
  astroDuck: {
    views: ["front", "side", "threeQuarter"],
    poses: ["celebrating", "sleeping", "waving", "pointing"],
    outfits: [
      "outfit-default-suit",
      "outfit-pirate",
      "outfit-wizard",
  ...
  satellite: {
    ...
    states: ["default", "inherited", "own-config", "unsaved", "error", "hovered", "selected"],
  ...
  background: {
    starfield: "starfield-tile.png",
    nebula: "nebula-overlay.png",
    constellation: "constellation-pattern.png",
    vignette: "vignette-soft.png",
  },
  ui: {
    modal: "ui/modal-frame.png",
    button: "ui/button-primary-states.png",
    input: "ui/input-states.png",
    toast: "ui/toast-variants.png",
  },
  // ─────────────────────────────────────────────────────────────────────────
  // Minigame Asset Presets (from zelos-minigame-asset-index.json)
  // ─────────────────────────────────────────────────────────────────────────
  shooter: {
    playerStates: ["idle", "thrust", "bank-left", "bank-right", "shoot", "hit", "death"],
    projectiles: ["shot-player", "shot-charged", "shot-enemy", "impact-spark"],
    enemies: ["enemy-a", "enemy-b", "enemy-c", "enemy-d", "enemy-e", "enemy-f", "enemy-g"],
    enemyStates: ["idle", "hit", "explode"],
    bosses: ["boss-1-orbital-core", "boss-2-nebula-leviathan"],
    bossStates: ["idle", "windup", "attack", "hit", "phase", "defeat"],
    pickups: ["shield", "double-shot", "speed-boost", "coin"],
    weapons: {
      basic: ["w1-single", "w2-spread", "w7-rail", "w9-ice"],
      trail: ["w4-homing", "w5-plasma"],
      explode: ["w4-homing", "w6-bomb"],
      beam: ["w3-laser"],
      shock: ["w8-shockwave"],
    },
    weaponElements: {
      basic: ["projectile", "muzzle", "impact"],
      trail: ["projectile", "trail", "impact"],
      explode: ["projectile", "explosion"],
      beam: ["beam-loop", "beam-cap-start", "beam-cap-end"],
      shock: ["ring", "impact"],
    },
    upgradeLevels: ["l1", "l2", "l3", "l4", "l5"],
  },
  platformer: {
    playerStates: ["idle", "run", "jump-start", "fall", "land", "crouch", "climb", "hit", "death"],
    enemies: ["slime", "drone", "spiker", "beetle", "bat", "cannon-bot"],
    enemyStates: ["idle", "hit", "defeat"],
    bosses: ["boss-1-reactor-guardian", "boss-2-sky-serpent"],
    bossStates: ["idle", "windup", "attack", "hit", "phase", "defeat"],
  },
  // ─────────────────────────────────────────────────────────────────────────
  // Audio Asset Presets (from zelos-audio-index.json)
  // ─────────────────────────────────────────────────────────────────────────
  audio: {
    shooterSfx: [
      "engine-idle-loop", "engine-thrust-loop",
      "shoot-single-01", "shoot-single-02", "shoot-single-03",
      "shoot-spread-01", "shoot-spread-02", "shoot-spread-03",
      "laser-start", "laser-loop", "laser-end",
      "charge-build", "charge-release",
      "hit-zap", "death-explosion",
      "missile-launch", "missile-explosion",
      "plasma-impact", "bomb-drop", "bomb-explosion",
      "shockwave-pulse", "ice-shard-hit",
      "enemy-spawn", "enemy-hit",
      "enemy-explode-small", "enemy-explode-medium", "enemy-explode-large",
      "boss-intro-sting", "boss-phase-riser",
      "pickup-powerup", "score-tick",
      "pause-in", "pause-out", "game-over",
    ],
    platformerSfx: [
      "step-01", "step-02", "step-03",
      "jump-start", "jump-land",
      "crouch-stand", "hit", "death",
      "coin-pickup", "checkpoint",
      "platform-move-loop", "hazard-hit",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Cinematic Presets (from zelos-asset-index.json)
  // ─────────────────────────────────────────────────────────────────────────
  cinematics: {
    clips: [
      "office-briefing",
      "intro-briefing-l1", "boss-intro-l1",
      "intro-briefing-l2", "boss-intro-l2",
      "mid-arc-l3-stargate", "boss-intro-l3",
      "intro-briefing-l4", "boss-intro-l4",
      "intro-briefing-l5", "final-boss-intro-l5",
      "outro-wrap", "stargate-travel",
    ],
  },
};
